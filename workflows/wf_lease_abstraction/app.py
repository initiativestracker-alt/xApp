...
Substitution tokens (replaced by builders.py at scaffold time):
    wf_lease_abstraction    → e.g. wf_lease_abstraction
    Lease Abstraction  → e.g. Lease Abstraction
    5001           → e.g. 5001
"""
...
if __name__ == "__main__":
    # use_reloader=False avoids the double-process startup that debug=True triggers,
    # so workflow_manager can track a single stable PID and the port binds faster.
